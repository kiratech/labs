...
developed during the Building Castles GitLab Ultimate course.
...
All the labs that are going to be implemented will lead to the GitLab Ultimate
registry being available at the `172.16.99.1:5050` address, this will be also
used by Kubernetes.
...
```console
$ minikube start --insecure-registry=172.16.99.1:5050
...
```
